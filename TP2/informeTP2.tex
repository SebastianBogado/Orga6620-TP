...
\setcounter{enumi}{-1}
 ...
 \item  \textbf{Reemplazar los accesos de tipo \texttt{wator[i][j]} en los ciclos por aritm\'etica de punteros. Se guarda un puntero a la primer posici\'on y se incrementa de forma tal de recorrer toda la matriz (\textit{show\_wator, init\_wator, move\_all})}
...
\begin{center}
  \begin{tabular}{ c | c | c | c | c | c | c | c | c | c | c }
    \hline
                & wator & 1wator & 2wator & 3wator & 4wator & 5wator & 6wator & 7wator & 8wator & 9wator & 10wator  \\ \hline
Tiempo promedio &       &        &        &        &        &        &        &        &        &        &          \\ \hline
SU parcial      &       &        &        &        &        &        &        &        &        &        &          \\ \hline
SU acumulado    &       &        &        &        &        &        &        &        &        &        &          \\ \hline
  \end{tabular}
\end{center}

    Se puede ver que hubo varias mejoras que no afectaron mucho el tiempo de ejecuci\'on del programa, como las versiones x, y _y_ z. A su vez, la(s) versi\'on X (Y) aportaron un x\% al speed up. En esas versiones, los cambios fueron -blah-, y explicar con más detalle por qué aportó tanto.
